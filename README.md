...
> ⚠️ **Примечание:** Данный проект создан в образовательных и некоммерческих целях. Пожалуйста, поддерживайте официальные релизы аниме.
...
> *Замените ссылки ниже на реальные скриншоты вашего приложения!*
...
- **Язык программирования:** [Python 3.8+](https://www.python.org/)
